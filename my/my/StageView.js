...
require(function(geom, Tiles, Action) {
  var StageView;
  return StageView = (function() {
    ...
    function StageView(el) {
      var canvas, cont, h, uiCanvas, w;
      this.el = el;
      ...
      w = this.tw * this.vw;
      h = this.th * this.vh;
      cont = $("<div class=\"stageViewContainer\"></div>").css({
        width: w,
        height: h
      }).appendTo(this.el);
      ...
      this.ui = getCanvasContext(uiCanvas);
      this.actionsBuf = [];
      this.ready = true;
      this.readyCallbacks = [];
    }
    ...
    StageView.prototype.update = function(g) {
      this.ready = false;
      return this.tiles.onload((function(_this) {
        return function() {
          ...
          animate(ANIM_DURATION * n, function(t) {
            var cell, colors, coords, drawOpacity, fin, finish, lastVis, mid, mob, moves, newVis, opc, p, st, tt, vis, visS, x, x0, x1, xy, y, y0, y1, _k, _l, _len2, _len3, _m, _n, _ref, _ref1, _ref2, _ref3, _results;
            tt = t * n;
            ...
            for (visS in drawOpacity) {
              ...
              _results.push((function() {
                var _len4, _o, _results1;
                _results1 = [];
                for (_o = 0, _len4 = coords.length; _o < _len4; _o++) {
                  xy = coords[_o];
                  _results1.push(this.ctx.fillRect(xy.x, xy.y, this.tw, this.th));
                }
                return _results1;
              }).call(_this));
            }
    ...
    StageView.prototype.setTarget = function(p) {
      ...
      this.ui.clear();
      this.ui.save();
      this.ui.strokeStyle = '#00ff00';
      this.ui.lineWidth = 2;
      this.ui.beginPath();
      this.ui.arc(xy.x, xy.y, this.tw / 2, 0, 2 * Math.PI);
      this.ui.stroke();
      return this.ui.restore();
    };
