...
var $c0, $gmap, ANIM_DURATION, ANIM_TRANSITION, Cell, Feature, INTERSECT_CHANCE, Item, Keys, Mob, MobGlyph, Mode, PointSet, Region, RegionTraits, Stage, Terrain, Timeline, animateMap, animateMobs, attempt, chance, clearTarget, coinflip, ctx, ctx0, distance, distance2, doorTile, drawLine, drawPoint, drawTarget, floorTile, isInt, itemTile, keyMap, loadImage, makeCorridor, makeRandomRoom, makeTrail, mobGlyphs, mobTile, mode, move, moveTarget, nextId, p, playerTile, point, pox, poy, prepareTiles, process, profile, quadrant, random, randomBetween, randomIn, randomMob, randomOf, raycast, repeat, selectTarget, setup, showMap, showMapTiles, showMobs, sign, th, tw, updateMap, updateTarget, viewHeight, viewWidth, wallTile, _id,
...
showMapTiles = function(pdx, pdy, moves) {
  var before, h, time, w, x0, x1, y0, y1;
  if (!(pdx === 0 && pdy === 0)) {
  ...
  return animateMobs(moves).then(function() {
...
$(function() {
  ...
  $('#test').click((function(_this) {
    return function() {
      return raycast(0.5, 0.5, 1, 2, 5, function(_arg) {
        var x, y;
        x = _arg.x, y = _arg.y;
