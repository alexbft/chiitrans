...
var $c0, $gmap, ANIM_DURATION, ANIM_TRANSITION, Cell, Feature, INTERSECT_CHANCE, Item, Keys, Mob, MobGlyph, Mode, PointSet, Region, RegionTraits, Stage, Terrain, Timeline, allLoaded, animateMap, animateMobs, attempt, chance, clearTarget, coinflip, ctx, ctx0, distance, distance2, doorTile, drawLine, drawPoint, drawTarget, floorTile, imgLoaded, isInt, itemTile, keyMap, loadImage, makeCorridor, makeRandomRoom, makeTrail, mobGlyphs, mobTile, mode, move, moveTarget, nextId, p, playerTile, point, pox, poy, prepareTiles, process, profile, quadrant, random, randomBetween, randomIn, randomMob, randomOf, raycast, repeat, selectTarget, setup, showMap, showMapTiles, showMobs, sign, th, tw, updateMap, updateTarget, viewHeight, viewWidth, wallTile, _id,
